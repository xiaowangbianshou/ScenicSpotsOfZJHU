<template>
  <div>
    ...
    <div style="margin: 10px 0">
      ...
      <el-input style="width: 200px" placeholder="请输入学号" suffix-icon="el-icon-position" class="ml-5" v-model="studentid"></el-input>
...
export default {
  ...
  methods: {
    ...
    delBatch(){
      ...
      this.$http.post("/user/del/batch",ids).then(res=>{
        if(res.data){
